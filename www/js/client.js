...
function initPeer() {
  ...
  function welcomeUser() {
    ...
    Swal.fire({
      ...
      imageAlt: "takesolve-welcome",
      imageUrl: welcomeImg,
      html:
        `
      <br/> 
      <p style="color:white;display:none">Share this meeting invite others to join.</p>
      <p style="color:white;">Thanks for start the meeting.</p>
      ...
      if (result.isConfirmed) {
        ...
        let message = {
          email: "",
          subject: "Please join our Takesolve Video Chat Meeting",
